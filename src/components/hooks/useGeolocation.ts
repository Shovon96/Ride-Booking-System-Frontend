...
export const useContinuousLocation = (userId: string) => {
    ...
    const fetchAddress = useCallback(async (lat: number, lng: number) => {
        ...
        try {
            // console.log( API_KEY ) pk.8e304f61cd0d79b2339f0aedc14686cc
            const res = await axios.get(
                `https://us1.locationiq.com/v1/reverse?key=pk.8e304f61cd0d79b2339f0aedc14686cc&lat=${lat}&lon=${lng}&format=json&_gl=1*1jxiud2*_ga*MTkxNDUwNTc4Ny4xNzU1OTY2MjIx*_ga_TRV5GF9KFC*czE3NTU5NjYyMjEkbzEkZzEkdDE3NTU5NjY4MTMkajYwJGwwJGgw`,
            );
